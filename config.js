...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://qu.ax/hcaBj.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://qu.ax/hcaBj.jpg;https://chat.whatsapp.3C4wrQmt0GG6io1IBIHb',
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Raganork MD bot;https://qu.ax/hcaBj.jpg' : process.env.AUDIO_DATA,
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY || 'HRKU-9c4b8c31-dd01-4ff2-8061-9801f364e507',
        APP_NAME: process.env.HEROKU_APP_NAME || 'nilim'
    },
